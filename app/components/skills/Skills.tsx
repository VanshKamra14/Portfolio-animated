...
const Skills = () => {
  return (
    <SectionContainer id="skills">
      ...
      alt="Background grid" width={569} height={373}
      className="hidden dark:md:block -z-10 absolute -left-[135px] -top-[39x]"
       />
       <Image src="/tech_stack_grid.svg"
      alt="Background grid" width={569} height={373}
      className="hidden dark:hidden md:block -z-10 absolute -left-[125px] -top-[39x]"
       />
      </>
    </SectionContainer>
  )
