...
const TopBackground = () => {
  ...
  md:max-w-screen-lg h-[285px] md:h-[656px] top-[188px]
  ...
  alt='Top dark mode bg highlight'
  width={809}
  height={877}
  ...
  alt='Top dark mode bg highlight for mobile'
  width={429}
  height={465}
  ...
  bg-[url('/top_bg_light.svg')] 
  bg-[auto_auto] hidden 
  dark:hidden md:block " />
  <div className="absolute top-0 w-full h-[600px] bg-repeat-x 
  bg-[url('/top_bg_mobile_light.svg')] 
  bg-[auto_auto] 
  dark:hidden md:hidden " />
   <div className="absolute top-0 w-full h-[795px] bg-repeat-x 
  bg-[url('/top_bg_dark.svg')] 
  bg-[auto_auto] hidden 
  md:dark:block " />
  <div className="absolute top-0 w-full h-[600px] bg-repeat-x 
  bg-[url('/top_bg_mobile_dark.svg')] 
  bg-[auto_auto] hidden
